...
// reduce : 배열이 주어졌을 때 베열 안의 모든 값들로 어떤걸 연산해야 할 때 사용
const num = [1, 2, 3, 4, 5, 6, 7, 8, 9];
// accumulator : 누적된 값
// current : 요소
const total = num.reduce((accumulator, current) => accumulator + current, 0); // 여기서 0은 accumulator의 초기 값 : 0부터 시작함, accumulator의 : 누적된 값, current은 각 요소의 값들
